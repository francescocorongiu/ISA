...
# Created by write_sdc on Fri Nov 20 00:25:55 2020
...
create_clock [get_ports clk]  -name clk1  -period 0.69  -waveform {0 0.345}
set_clock_uncertainty 0.07  [get_clocks clk1]
set_max_delay 0.69  -from [list [get_ports {FP_A[31]}] [get_ports {FP_A[30]}] [get_ports          \
