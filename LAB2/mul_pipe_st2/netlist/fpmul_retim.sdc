...
# Created by write_sdc on Fri Nov  6 23:41:48 2020
...
create_clock [get_ports clk]  -name clk1  -period 0  -waveform {0 0}
set_clock_uncertainty 0.07  [get_clocks clk1]
set_max_delay 0  -from [list [get_ports {FP_A[31]}] [get_ports {FP_A[30]}] [get_ports          \
