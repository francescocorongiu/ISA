...
# Created by write_sdc on Tue Nov 10 17:01:18 2020
...
create_clock [get_ports clk]  -name clk1  -period 4.3  -waveform {0 2.15}
set_clock_uncertainty 0.07  [get_clocks clk1]
set_max_delay 4.3  -from [list [get_ports {FP_A[31]}] [get_ports {FP_A[30]}] [get_ports          \
