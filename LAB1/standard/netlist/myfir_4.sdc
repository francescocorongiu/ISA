...
# Created by write_sdc on Sat Nov 14 17:25:36 2020
...
create_clock [get_ports CLK]  -name clk1  -period 9.6  -waveform {0 4.8}
set_clock_uncertainty 0.07  [get_clocks clk1]
set_max_delay 9.6  -from [list [get_ports CLK] [get_ports RST_n] [get_ports VIN] [get_ports      \
