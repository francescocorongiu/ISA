...
# Created by write_sdc on Fri Oct 30 16:25:40 2020
...
create_clock [get_ports CLK]  -name clk1  -period 1.1  -waveform {0 0.55}
set_clock_uncertainty 0.07  [get_clocks clk1]
set_max_delay 1.1  -from [list [get_ports CLK] [get_ports RST_n] [get_ports VIN] [get_ports      \
