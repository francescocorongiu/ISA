...
# Created by write_sdc on Fri Oct 30 16:47:01 2020
...
create_clock [get_ports CLK]  -name clk1  -period 2  -waveform {0 1}
set_clock_uncertainty 0.07  [get_clocks clk1]
set_max_delay 2  -from [list [get_ports CLK] [get_ports RST_n] [get_ports VIN] [get_ports      \
